  ...
  switch (operation) {
    case kCCEncrypt:
      ...
      //salt = [self randomDataOfLength:kPBKDFSaltSize];
          ...
          //Byte markVal[] = {0x8F, 0x0E, 0xC6, 0xB1}; //4 byte
          marker = [NSData dataWithBytes:MARKER length:sizeof(MARKER)];

      if (![outStream _CMwriteData:marker error:error] || ![outStream _CMwriteData:iv error:error] ) {
        return NO;
      }
      break;
    case kCCDecrypt:
